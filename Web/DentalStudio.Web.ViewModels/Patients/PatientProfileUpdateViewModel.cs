namespace DentalStudio.Web.ViewModels.Patients
{
    ...
    public class PatientProfileUpdateViewModel : IMapTo<PatientServiceModel>, IMapFrom<PatientServiceModel>, IHaveCustomMappings
    {
        ...
        {
            configuration
            .CreateMap<PatientServiceModel, PatientProfileUpdateViewModel>()
               .ForMember(
