namespace DentalStudio.Web.ViewModels.Patients
{
    ...
    public class PatientAppointmentDetailsViewModel : IMapTo<AppointmentServiceModel>, IMapFrom<AppointmentServiceModel>, IHaveCustomMappings
    {
        ...
        {
            configuration
            .CreateMap<AppointmentServiceModel, PatientAppointmentDetailsViewModel>()
             .ForMember(
