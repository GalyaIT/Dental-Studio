namespace DentalStudio.Web.ViewModels.Administration.Doctors
{
    ...
    public class DoctorEditViewModel : IMapTo<DoctorServiceModel>, IMapFrom<DoctorServiceModel>, IHaveCustomMappings
    {
        ...
        {
            configuration
             .CreateMap<DoctorServiceModel, DoctorEditViewModel>()
               .ForMember(
