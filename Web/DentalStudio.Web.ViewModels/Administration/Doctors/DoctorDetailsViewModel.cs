namespace DentalStudio.Web.ViewModels.Administration.Doctors
{
    ...
    public class DoctorDetailsViewModel : IMapTo<DoctorServiceModel>, IMapFrom<DoctorServiceModel>, IHaveCustomMappings
    {
        ...
        {
            configuration
            .CreateMap<DoctorServiceModel, DoctorDetailsViewModel>()
            .ForMember(
