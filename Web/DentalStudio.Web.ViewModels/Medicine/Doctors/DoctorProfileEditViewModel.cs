namespace DentalStudio.Web.ViewModels.Medicine.Doctors
{
    ...
    public class DoctorProfileEditViewModel : IMapTo<DoctorServiceModel>, IMapFrom<DoctorServiceModel>, IHaveCustomMappings
    {
        ...
        {
            configuration
             .CreateMap<DoctorServiceModel, DoctorProfileEditViewModel>()
               .ForMember(
