namespace DentalStudio.Web.ViewModels.Medicine.Doctors
{
    ...
    public class DoctorProfileDetailsViewModel : IMapTo<DoctorServiceModel>, IMapFrom<DoctorServiceModel>, IHaveCustomMappings
    {
        ...
        {
            configuration
            .CreateMap<DoctorServiceModel, DoctorProfileDetailsViewModel>()
            .ForMember(
