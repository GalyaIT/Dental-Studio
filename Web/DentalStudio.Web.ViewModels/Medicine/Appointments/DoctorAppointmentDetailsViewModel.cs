namespace DentalStudio.Web.ViewModels.Medicine.Appointments
{
    ...
    public class DoctorAppointmentDetailsViewModel : IMapTo<AppointmentServiceModel>, IMapFrom<AppointmentServiceModel>, IHaveCustomMappings
    {
        ...
        {
            configuration
            .CreateMap<AppointmentServiceModel, DoctorAppointmentDetailsViewModel>()
             .ForMember(
