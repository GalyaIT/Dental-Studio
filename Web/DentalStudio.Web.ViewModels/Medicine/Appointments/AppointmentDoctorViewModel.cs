namespace DentalStudio.Web.ViewModels.Medicine.Appointments
{
    ...
    public class AppointmentDoctorViewModel : IMapFrom<AppointmentServiceModel>, IHaveCustomMappings
    {
        ...
        {
            configuration
             .CreateMap<AppointmentServiceModel, AppointmentDoctorViewModel>()
             .ForMember(
